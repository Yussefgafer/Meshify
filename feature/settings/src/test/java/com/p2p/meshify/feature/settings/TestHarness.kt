...
@Composable fun DxThemeSettings(content: @Composable () -> Unit){ val f=FakePremiumHaptics(); CompositionLocalProvider(LocalPremiumHaptics provides f){ DxTheme(dynamicColor=false){content()}} }
@Composable fun DxThemeSettingsFake(fake: FakePremiumHaptics, content: @Composable () -> Unit){ CompositionLocalProvider(LocalPremiumHaptics provides fake){ DxTheme(dynamicColor=false){content()}} }

@Suppress("UNCHECKED_CAST")
fun <T> injectSettingsState(vm: Any, fieldName: String, value: T) {
    try {
