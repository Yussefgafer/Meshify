...
@Composable fun DxThemeTestDisc(content: @Composable () -> Unit){ val f=FakePremiumHaptics(); CompositionLocalProvider(LocalPremiumHaptics provides f){ DxTheme(dynamicColor=false){content()}} }
@Composable fun DxThemeTestDiscFake(fake: FakePremiumHaptics, content: @Composable () -> Unit){ CompositionLocalProvider(LocalPremiumHaptics provides fake){ DxTheme(dynamicColor=false){content()}} }

@Suppress("UNCHECKED_CAST")
fun <T> injectDiscoveryState(vm: Any, fieldName: String, value: T) {
    try {
